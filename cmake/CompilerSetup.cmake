...
if (UNIX)
    if (CMAKE_CXX_COMPILER_ID STREQUAL "Clang" AND LLVM_BUILD)
        target_link_options(${PROJECT_NAME} PRIVATE -stdlib=libc++ -L${CMAKE_BINARY_DIR}/lib -fuse-ld=${LLD} --rtlib=compiler-rt -Wl,--as-needed)
        target_link_libraries(${PROJECT_NAME} PRIVATE ${LLVM_LIBS})
        target_include_directories(${PROJECT_NAME} SYSTEM BEFORE PRIVATE ${LIBCXXABI_INCLUDE_HEADERS} ${LIBCXX_INCLUDE_HEADERS} /usr/include/)

        add_dependencies(${PROJECT_NAME} ${LLVM_LIBS})
